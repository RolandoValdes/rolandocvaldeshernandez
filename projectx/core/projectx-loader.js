...
async function initialiseProjectX() {
  await loadComponent("projectxSidebar", `${ProjectXConfig.basePath}/components/sidebar/sidebar.html`);
  await loadComponent("projectxHeader", `${ProjectXConfig.basePath}/components/header/header.html`);
  if (typeof initialiseNavigation === "function") initialiseNavigation();
  if (typeof initialiseTheme === "function") initialiseTheme();
}
